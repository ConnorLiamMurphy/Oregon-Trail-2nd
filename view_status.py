...
def view_status(inv: InventoryAndStats, act: Actions):
    ...
    _layout = [
        ...
        [sg.Text(f'Morale: {inv.get_morale()}', size=(20, 1), font=('Helvetica', 14))],
        [sg.Text(f'Health: {inv.get_health()}/10', size=(20, 1), font=('Helvetica', 14))],
        [sg.Text(f'Distance from Oregon: {_distance}', size=(20, 1), font=('Helvetica', 14))],  # Show distance here
